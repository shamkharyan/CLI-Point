...
{
	class DuplicateSlideCommandFactory : public ICommandFactory
	{
	public:
		DuplicateSlideCommandFactory(core::ActionManager& actionManager, model::Presentation& presentation);
